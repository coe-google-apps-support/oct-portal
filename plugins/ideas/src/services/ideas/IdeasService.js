...
let x = class IdeasService {
   ...
   * @param {string} supportingDocumentsDto A list of supporting documents of the initiative.
   ...
   */
  static createInitiative (title, description, supportingDocumentsDto, businessSponsorEmail, hasBudget, expectedTargetDate) {
    return HTTP.post('', {
      title,
      description,
