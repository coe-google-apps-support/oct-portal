...
namespace CoE.Ideas.ProjectManagement.Tests
{
    ...
    {
        private static GitHubIssueEvent _sampleGitHubIssueEvent;

        public static GitHubIssueEvent GetSampleGitHubIssueEvent()
        {
            if (_sampleGitHubIssueEvent == null)
            {
                // we'll do this the easy way.
                _sampleGitHubIssueEvent = JsonConvert.DeserializeObject<GitHubIssueEvent>(_sampleGitHubIssueJson);
            }
            return _sampleGitHubIssueEvent;
        }
